...
""",
            ...
            ([37], [], [[(0, 0, 1, ['A table with one cell and one line.'])]]),
        ],
        [
            """\
+--------------+--------------+
...
""",
            ...
            (
                [14, 14],
                [],
                [[(0, 0, 1, ['A table with']), (0, 0, 1, ['two columns.'])]],
            ),
        ],
        [
            """\
...
""",
            [
                ...
                (
                    ...
                    7,
                    27,
                    ['First and last rows', 'contain column spans.'],
                ),
            ],
            (
                [12, 13],
                [],
                [
                    [(0, 1, 1, ['A table with three rows,']), None],
                    [(0, 0, 3, ['and two']), (0, 0, 3, ['columns.'])],
                    [
                        (
                            0,
                            1,
...
""",
            ...
            (
                [12, 18],
                [
                    [(0, 1, 1, ['A table with two header rows,']), None],
                    [(0, 0, 3, ['the first']), (0, 0, 3, ['with a span.'])],
                ],
                [
                    [(0, 0, 5, ['Two body']), (0, 0, 5, ['rows,'])],
                    [(0, 1, 7, ['the second with a span.']), None],
                ],
            ),
        ],
        [
